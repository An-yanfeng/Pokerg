...
fn1();
    ...
    setTimeout(function(){
            els[0].style.webkitTransform = 'rotateZ(360deg)';
    },0)

    setTimeout(function(){
        els[1].style.webkitTransform = 'rotateZ(360deg)';
    },500)
    setTimeout(function(){
        els[2].style.webkitTransform = 'rotateZ(360deg)';
    },500)
    setTimeout(function(){
        els[3].style.webkitTransform = 'rotateZ(360deg)';
    },1000)
    setTimeout(function(){
        els[4].style.webkitTransform = 'rotateZ(360deg)';
    },1000)
    setTimeout(function(){
        els[5].style.webkitTransform = 'rotateZ(360deg)';
    },1000)
    setTimeout(function(){
        els[6].style.webkitTransform = 'rotateZ(360deg)';
    },1500)
    setTimeout(function(){
        els[7].style.webkitTransform = 'rotateZ(360deg)';
    },1500)
    setTimeout(function(){
        els[8].style.webkitTransform = 'rotateZ(360deg)';
    },1500)
    setTimeout(function(){
        els[9].style.webkitTransform = 'rotateZ(360deg)';
    },1500)
    setTimeout(function(){
        els[10].style.webkitTransform = 'rotateZ(360deg)';
    },2000)
    setTimeout(function(){
        els[11].style.webkitTransform = 'rotateZ(360deg)';
    },2000)
    setTimeout(function(){
        els[12].style.webkitTransform = 'rotateZ(360deg)';
    },2000)
    setTimeout(function(){
        els[13].style.webkitTransform = 'rotateZ(360deg)';
    },2000)
    setTimeout(function(){
        els[14].style.webkitTransform = 'rotateZ(360deg)';
    },2000)
    setTimeout(function(){
        els[15].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[16].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[17].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[18].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[19].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[20].style.webkitTransform = 'rotateZ(360deg)';
    },2500)
    setTimeout(function(){
        els[21].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[22].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[23].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[24].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[25].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[26].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
    setTimeout(function(){
        els[27].style.webkitTransform = 'rotateZ(360deg)';
    },3000)
